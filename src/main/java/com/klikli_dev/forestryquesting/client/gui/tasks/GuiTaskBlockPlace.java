...
public class GuiTaskBlockPlace extends GuiElement implements IGuiEmbedded {
    private GuiScrollingItems scrollList;
    private Minecraft mc;

    public GuiTaskBlockPlace(TaskBlockPlace task, IQuest quest, int posX, int posY, int sizeX, int sizeY) {
